...
object BleUuids {
    ...
    val PLAYLIST_CMD_CHAR: UUID  = UUID.fromString("4a5c6e7d-8f9a-4b2c-1d3e-5f6a7b8c9d07")
    val PLAYLIST_RESULT_CHAR: UUID = UUID.fromString("4a5c6e7d-8f9a-4b2c-1d3e-5f6a7b8c9d08")
