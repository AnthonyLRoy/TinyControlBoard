...
object ButtonCatalog {
    ...
    val gridItems: List<GridItem> = buildList {
        ...
        // Row 1: previous, play/pause (spans 2 cols), next — no text labels, tap-to-seek
        // on the progress bar replaces the old skip back/forward buttons.
        add(GridItem.Button(ButtonDef(1,  "Prev",        CMD_PREV,       1, R.drawable.ic_skip_previous)))
        add(GridItem.Button(ButtonDef(5,  "Play",       CMD_PLAY,       5, R.drawable.ic_play,       spanSize = 2, isPrimary = true, isToggle = true)))
        add(GridItem.Button(ButtonDef(2,  "Next",        CMD_NEXT,       2, R.drawable.ic_skip_next)))
        // Row 2: stop, repeat, shuffle
        ...
        add(GridItem.Button(ButtonDef(9,  "Shuffle",     0x011F,  9, R.drawable.ic_shuffle, spanSize = 2)))
        ...
        add(GridItem.Button(ButtonDef(15, "Display",     CMD_DISPLAY_OFF, 6, R.drawable.ic_brightness, spanSize = 2, isToggle = true)))
