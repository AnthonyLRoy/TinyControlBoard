...
object ButtonCatalog {
    ...
    val gridItems: List<GridItem> = buildList {
        ...
        add(GridItem.Button(ButtonDef(6,  "Stop",        CMD_STOP,       6, R.drawable.ic_stop)))
        ...
        add(GridItem.Button(ButtonDef(15, "Display Off", CMD_DISPLAY_OFF, 15, R.drawable.ic_brightness,   spanSize = 4)))
    }
}
