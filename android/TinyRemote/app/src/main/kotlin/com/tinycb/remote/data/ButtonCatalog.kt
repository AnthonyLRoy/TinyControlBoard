...
object ButtonCatalog {
    val buttons: List<ButtonDef> = listOf(
        ...
        // Row 5: brightness down/up + display toggle (stretched) — utility group
        ButtonDef(13, "Bright –",   0x0121, -1, R.drawable.ic_remove_circle, backgroundColorRes = R.color.btn_bg_utility),
        ButtonDef(14, "Bright +",   0x0120, -1, R.drawable.ic_add_circle, backgroundColorRes = R.color.btn_bg_utility),
        ButtonDef(15, "Display Off", 0x0114, 15, R.drawable.ic_brightness, spanSize = 2, backgroundColorRes = R.color.btn_bg_utility)
