...
#define PIN_RELAY_RPI GPIO_NUM_11               //  Raspbury Pi
#define PIN_RELAY_OUTPUT_STAGE GPIO_NUM_9       //  Output stage power relay
#define PIN_RELAY_GENERAL_3 GPIO_NUM_10         //  General purpose relay
