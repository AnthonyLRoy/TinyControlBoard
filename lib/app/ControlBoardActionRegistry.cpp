...
namespace controlSystem
{
    void ControlBoardActionRegistry::populate(ControlBoardInputDispatcher::ActionMap &rActionMap) const
    {
        ...
        rActionMap[controlBoardButtons::k_toggleDisplay]   = {&actions::DisplayOffOnInstance,       LedPolicy::Toggle};
        ...
        rActionMap[controlBoardButtons::k_nextPanel]    = {&actions::NextMenuInstance,          LedPolicy::Momentary};
